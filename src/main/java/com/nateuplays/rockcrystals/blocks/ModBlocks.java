...
//		GameRegistry.registerBlock(crystallineRoom = new BasicBlock("crystalline_room", Material.rock, 1.0f, 15.0f).setCreativeTab(com.nateuplays.rockcrystals.Main.tabRockCrystalMod), "crystalline_room");
		...
		GameRegistry.registerBlock(crystallineBlock = new TransparentBlock("crystalline_block", Material.ice, 1.00f, 1.0f).setCreativeTab(com.nateuplays.rockcrystals.Main.tabRockCrystalMod).setLightLevel(0.8f), "crystalline_block");
	}
}