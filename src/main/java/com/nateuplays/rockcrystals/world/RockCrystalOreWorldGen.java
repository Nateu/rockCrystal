package com.nateuplays.rockcrystals.world;
...
public class RockCrystalOreWorldGen implements IWorldGenerator {
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
	    ...
	    case 0: //Overworld
	    	this.runGenerator(this.rock_crystal_ore, world, random, chunkX, chunkZ, 20, 0 , 64);
	        break;
	    case -1: //Nether
	        break;
	    case 1: //End
